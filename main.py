...
if __name__ == "__main__":
    ...
    for cam_idx in range(1,cam_num+1):
        ...
        for seq_idx in range(0,seq_num):
            ...
            pattern_features = circular_sampling(img, kp, rad_circular_sampling, cir_num, non_maximum_thresh)
            result_pattern_features, ret = homography_estimation(img, pattern_features, horizontal_unit_num, vertical_unit_num, unit_square_size, scale_factor)
